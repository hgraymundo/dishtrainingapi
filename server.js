...
require('./route/functional-area.js')(app);
require('./route/role.js')(app);
require('./route/type-course.js')(app);
require('./route/course-category.js')(app);

require('./route/course.js')(app);
require('./route/account.js')(app);

require('./route/login.js')(app);

// require('./route/account.js')(app);
// require('./route/school.js')(app);
