var Object_ = require('../models').functional_area;
var cerrors = require('../helpers/custom-errors');
var validateFunctionalArea = require('../validations/functional_area');

module.exports = function(app) {
 
    var object_ = 'functional_area';

// CREATE
    app.post('/' + object_ , (req, res) => { console.log(" POST "+ object_ + " ::::::");
        let errors = validateFunctionalArea.validate(req);
        if( errors ) {
