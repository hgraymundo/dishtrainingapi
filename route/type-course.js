var Object_ = require('../models').type_course;
var cerrors = require('../helpers/custom-errors');
var validateTypeCourse = require('../validations/type-course');

module.exports = function(app) {
 
    var object_ = 'type-course';

// CREATE
    app.post('/' + object_ , (req, res) => { console.log(" POST "+ object_ + " ::::::");
        let errors = validateTypeCourse.validate(req);
        if( errors ) {
