var Object_ = require('../models').course_category;
var cerrors = require('../helpers/custom-errors');
var validateCourseCategory = require('../validations/course-category');

module.exports = function(app) {
 
    var object_ = 'course-category';

// CREATE
    app.post('/' + object_ , (req, res) => { console.log(" POST "+ object_ + " ::::::");
        let errors = validateCourseCategory.validate(req);
        if( errors ) {
